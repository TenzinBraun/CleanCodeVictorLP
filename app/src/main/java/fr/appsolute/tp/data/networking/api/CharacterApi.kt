...
interface CharacterApi {
    ...
    /**
     * @param int : Iny*t for the id of Character
     * @return A [Response] of [Character]
     */
    @GET(GET_SINGLE_CHARACTER_PATH)
    ...
    companion object {
        ...
        const val GET_SINGLE_CHARACTER_PATH = "character/{character_id}"
    }
